...
feature_index = read_feature_index("/Users/xstevens/workspace/socorro/analysis/feature-index.txt")
print "Feature Index: contains %d features" % (len(feature_index))
x = read_sparse_matrix("/Users/xstevens/workspace/socorro/analysis/data-matrix.txt", len(feature_index))
#y = pdist(x, 'euclidean')
